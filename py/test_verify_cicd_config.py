...
"""
    ...
    def test_check_upstream_pdk_action_tags_invalid(self):
        invalid_gds = "uses: TinyTapeout/tt-gds-action/custom_gds@ttsky26c"
        valid_docs = "uses: TinyTapeout/tt-gds-action/docs@ttihp26b"
